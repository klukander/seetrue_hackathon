...
class SceneImageReceiver:
    ...
    def receive_data(self):
        ...
        while True:
            if (
                self.shared_data
                and "stop" in self.shared_data
                and self.shared_data["stop"].value
            ):
                print("SceneImageReceiver: Stop flag detected, exiting...")
                break
        ...
        self.socket.close()
        self.context.term()
        print("SceneImageReceiver stopped.")
